...
ActiveRecord::Schema.define(:version => 20131213072528) do
  ...
  add_index "adjusters", ["email"], :name => "index_adjusters_on_email", :unique => true
  add_index "adjusters", ["reset_password_token"], :name => "index_adjusters_on_reset_password_token", :unique => true
  ...
  add_index "categories_projects", ["category_id", "project_id"], :name => "categories_projects_index", :unique => true
  ...
  add_index "contractors", ["slug"], :name => "index_contractors_on_slug", :unique => true
  ...
  add_index "contractors_trades", ["contractor_id", "trade_id"], :name => "contractors_trades_index", :unique => true
