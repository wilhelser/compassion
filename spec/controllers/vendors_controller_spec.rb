  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved vendor as @vendor" do
        ...
        post :create, {:vendor => { "project_id" => "invalid value" }}, valid_session
        assigns(:vendor).should be_a_new(Vendor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested vendor" do
        ...
        Vendor.any_instance.should_receive(:update_attributes).with({ "project_id" => "1" })
        put :update, {:id => vendor.to_param, :vendor => { "project_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the vendor as @vendor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Vendor.any_instance.stub(:save).and_return(false)
        put :update, {:id => vendor.to_param, :vendor => { "project_id" => "invalid value" }}, valid_session
        assigns(:vendor).should eq(vendor)
      end
